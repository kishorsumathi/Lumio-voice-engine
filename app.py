...
# ── Page config ──
st.set_page_config(page_title="Lumio Transcription Engine", page_icon="🎙️", layout="wide")
...
if not st.session_state["authenticated"]:
    st.title("🎙️ Lumio Transcription Engine")
    st.markdown("---")
    ...
    with col_center:
        ...
        if st.button("Login", key="login_btn", use_container_width=True):
            if username == "Lumiovoice" and password == "voice@testdevelopment":
...
st.title("Lumio Transcription Engine")
